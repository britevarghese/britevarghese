...
const MODELS = {
  bolt_action_rifle_7_62: { out: 'weapons/bolt_action_rifle.glb', tex: 1024 },
  service_pistol: { out: 'weapons/service_pistol.glb', tex: 1024 },
  stick_grenade: { out: 'weapons/grenade.glb', tex: 512 },
  concrete_road_barrier: { out: 'props/concrete_barrier.glb', tex: 512, simplify: 0.12 },
  concrete_road_barrier_02: { out: 'props/concrete_barrier_02.glb', tex: 512, simplify: 0.2 },
  wooden_military_crate: { out: 'props/military_crate.glb', tex: 512, simplify: 0.4 },
  old_military_crate: { out: 'props/old_military_crate.glb', tex: 512, simplify: 0.6 },
  ammo_box: { out: 'props/ammo_box.glb', tex: 512 },
  Barrel_01: { out: 'props/barrel.glb', tex: 512 },
  barrel_03: { out: 'props/barrel_rusty.glb', tex: 512 },
  covered_car: { out: 'props/covered_car.glb', tex: 1024 },
  metal_jerrycan_green: { out: 'props/jerrycan.glb', tex: 512 },
  cement_bag: { out: 'props/cement_bag.glb', tex: 512 },
  old_tyre: { out: 'props/tyre.glb', tex: 512 },
  utility_box_01: { out: 'props/utility_box.glb', tex: 512 },
  street_lamp_01: { out: 'props/street_lamp.glb', tex: 512, simplify: 0.3 },
  exterior_aircon_unit: { out: 'props/aircon.glb', tex: 512, simplify: 0.4 },
  metal_trash_can: { out: 'props/trash_can.glb', tex: 512, simplify: 0.5 },
  portable_generator: { out: 'props/generator.glb', tex: 512, simplify: 0.4 },
  rollershutter_door: { out: 'props/rollershutter_door.glb', tex: 1024 },
  modular_chainlink_fence: { out: 'props/chainlink_fence.glb', tex: 512, simplify: 0.35 },
  modular_electricity_poles: { out: 'props/electricity_poles.glb', tex: 512, simplify: 0.15 },
  rusted_wheel_rim_01: { out: 'props/wheel_rim.glb', tex: 512, simplify: 0.4 },
  tree_small_02: [
    { out: 'vegetation/tree_small_02_lod0.glb', tex: 1024, simplify: 0.12, foliage: { keep: 0.022, scale: 3.6, leafRatio: 0.5 } },
    { out: 'vegetation/tree_small_02_lod1.glb', tex: 512, simplify: 0.03, foliage: { keep: 0.006, scale: 6.5, leafRatio: 0.3 } },
  ],
  grass_medium_01: { out: 'vegetation/grass_medium_01.glb', tex: 512, simplify: 0.35, error: 0.05 },
  ...
  dead_tree_trunk: { out: 'vegetation/dead_tree_trunk.glb', tex: 512, simplify: 0.08 },
  rock_07: { out: 'vegetation/rock_07.glb', tex: 512, simplify: 0.25 },
  rock_09: { out: 'vegetation/rock_09.glb', tex: 512, simplify: 0.25 },
};
