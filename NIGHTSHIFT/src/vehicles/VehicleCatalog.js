...
const REAL = [
  ...
  { id: 'subaru_wrx_sti_gc8', brand: 'Subaru', model: 'Impreza WRX STi (GC8)', year: 1999, tier: 'D', carType: 'tuner', unlock: { level: 3 }, price: 29000,
    ...
    src: { uid: '457f01e7e8d14b088e3f092c1be9e75c', title: 'Subaru Impreza WRX STi Version VI (GC8)', author: 'Car2022' }, standIn: 'sa_sedan' },
  ...
  { id: 'porsche_930_turbo', brand: 'Porsche', model: '911 Turbo (930)', year: 1975, tier: 'C', carType: 'sports', unlock: { mission: 'widowmaker' }, price: 45000,
    ...
    src: { uid: '8568d9d14a994b9cae59499f0dbed21e', title: 'FREE 1975 Porsche 911 (930) Turbo', author: 'lionsharp' }, standIn: 'sa_fastback', powerOversteer: 1.3 },
  { id: 'nissan_skyline_r34', brand: 'Nissan', model: 'Skyline GT-R (R34)', year: 1999, tier: 'C', carType: 'tuner', unlock: { level: 6 }, price: 48000,
    ...
    src: { uid: 'ff8fb2251dfa4bb9979e7022c5a6666c', title: 'Nissan Skyline R34 GT-R', author: 'Lexyc16' }, standIn: 'sa_sedan' },
  ...
  { id: 'honda_nsx_na1', brand: 'Honda', model: 'NSX (NA1)', year: 1990, tier: 'C', carType: 'sports', unlock: { level: 9 }, price: 58000,
    ...
    src: { uid: '1cc15628a00a4739a6b6c01128927c8d', title: 'Honda NSX 1990', author: 'Lexyc16' }, standIn: 'sa_wedge' },
  { id: 'bmw_m4_f82', brand: 'BMW', model: 'M4 Coupé (F82)', year: 2014, tier: 'B', carType: 'sports', unlock: { level: 11 }, price: 78000,
    ...
    src: { uid: '25d00f20b8cf4828bd934acb31e0aae4', title: 'BMW M4 F82 Razor 2014', author: 'heynic (www.vecarz.com)' }, standIn: 'sa_sedan', powerOversteer: 1.15 },
  ...
  { id: 'chevrolet_corvette_c8', brand: 'Chevrolet', model: 'Corvette Stingray (C8)', year: 2020, tier: 'B', carType: 'muscle', unlock: { level: 14 }, price: 105000,
    ...
    src: { uid: '790c40ccff6843eab0b7b4bd18421ff8', title: '2019 Chevrolet Corvette C8 Stingray', author: 'Haris3D' }, standIn: 'sa_wedge' },
  { id: 'porsche_911_gt3', brand: 'Porsche', model: '911 GT3', year: 2018, tier: 'B', carType: 'exotic', unlock: { mission: 'track_weapon' }, price: 125000,
    ...
    src: { uid: '78d5c47ab2554c2592b7e499179a0792', title: 'Porsche 911 GT3', author: 'ChevroletSS' }, standIn: 'sa_fastback' },
  { id: 'audi_r8_v10', brand: 'Audi', model: 'R8 V10 performance quattro', year: 2021, tier: 'A', carType: 'exotic', unlock: { level: 18 }, price: 175000,
    ...
    src: { uid: '8dd1c237238244d1a2a49d764d321b87', title: '2021 Audi R8 V10 Performance Quattro (Type 4S)', author: 'supercarmodels' }, standIn: 'sa_wedge' },
  { id: 'ferrari_f40', brand: 'Ferrari', model: 'F40', year: 1987, tier: 'A', carType: 'exotic', unlock: { mission: 'legend_of_the_night' }, price: 260000,
    ...
    src: { uid: '52a66c41cfcd4f999fb1b1c49bf24d70', title: 'Ferrari f40', author: 'BlackSnow02' }, standIn: 'sa_wedge', powerOversteer: 1.25 },
...
const REAL_BIKES = [
  ...
  { id: 'kawasaki_zx6r', brand: 'Kawasaki', model: 'Ninja ZX-6R', year: 2024, tier: 'D', carType: 'tuner', unlock: { level: 3 }, price: 15000, style: 'sport',
    spec: { seat: 0.83, trans: 'qs', kw: 91, kg: 197, t100: 3.3, vmax: 260, len: 2.025, wid: 0.72, hgt: 1.1, wb: 1.4, wr: 0.31, fw: 0.52, redline: 16000, gears: [2.85, 2.2, 1.85, 1.6, 1.44, 1.33], fd: 5.3, grip: 1.16, era: 2024 },
  ...
  { id: 'yamaha_r1', brand: 'Yamaha', model: 'YZF-R1', year: 2015, tier: 'C', carType: 'tuner', unlock: { level: 8 }, price: 26000, style: 'sport',
    spec: { seat: 0.855, trans: 'qs', kw: 147, kg: 199, t100: 3.0, vmax: 299, len: 2.055, wid: 0.69, hgt: 1.15, wb: 1.405, wr: 0.315, fw: 0.53, redline: 14000, gears: [2.6, 2.18, 1.84, 1.6, 1.45, 1.35], fd: 4.05, grip: 1.2, era: 2015 },
